...
-------------------------------------------------------------------------------
BEGIN
  FOR hotel_id IN 1..25 LOOP
    -- Saltar los hoteles 4,5,6 que no existen
    IF hotel_id NOT IN (4,5,6) THEN
      -- Insertar 5 servicios con nombres y costos aleatorios
      INSERT INTO Servicios (id_servicio, id_hotel, nombre_del_servicio, costo_por_servicio) VALUES (Servicios_seq.NEXTVAL, hotel_id, 'WiFi', DBMS_RANDOM.VALUE(10,60));
      INSERT INTO Servicios (id_servicio, id_hotel, nombre_del_servicio, costo_por_servicio) VALUES (Servicios_seq.NEXTVAL, hotel_id, 'Desayuno', DBMS_RANDOM.VALUE(10,60));
      INSERT INTO Servicios (id_servicio, id_hotel, nombre_del_servicio, costo_por_servicio) VALUES (Servicios_seq.NEXTVAL, hotel_id, 'Piscina', DBMS_RANDOM.VALUE(10,60));
      INSERT INTO Servicios (id_servicio, id_hotel, nombre_del_servicio, costo_por_servicio) VALUES (Servicios_seq.NEXTVAL, hotel_id, 'Gimnasio', DBMS_RANDOM.VALUE(10,60));
      INSERT INTO Servicios (id_servicio, id_hotel, nombre_del_servicio, costo_por_servicio) VALUES (Servicios_seq.NEXTVAL, hotel_id, 'Spa', DBMS_RANDOM.VALUE(10,60));
    END IF;
  END LOOP;
  COMMIT;
END;
